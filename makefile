...
CC                  = clang
FLAGS               = -std=c23 -pedantic -Wall -Wextra -Wpedantic -ggdb -Wno-gnu -Wno-gcc-compat -fenable-matrix -DVERSION=\"$(VERSION)\" -DGIT_COMMIT=\"$(GIT_COMMIT)\"
FLAGS_DEBUG         = -DIS_DEBUG=true -O0 -fsanitize=address,undefined
FLAGS_RELEASE       = -DIS_DEBUG=false -O3
FLAGS_LINUX         =
