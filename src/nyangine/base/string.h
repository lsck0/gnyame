...
extern NYA_String      nya_string_new_with_capacity(NYA_Arena* arena, u32 capacity);
extern NYA_String      nya_string_sprintf(NYA_Arena* arena, const char* fmt, ...) __attr_fmt_printf(2, 3);
extern NYA_String      nya_string_substring_excld(NYA_Arena* arena, const NYA_String* str, u32 start, u32 end);
extern NYA_String      nya_string_substring_incld(NYA_Arena* arena, const NYA_String* str, u32 start, u32 end);
