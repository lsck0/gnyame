...
extern NYA_String      nya_string_clone(NYA_Arena* arena, const NYA_String* str);
extern NYA_String      nya_string_concat(NYA_Arena* arena, const NYA_String* str1, const NYA_String* str2);
extern NYA_String      nya_string_from(NYA_Arena* arena, const char* cstr) __attr_overloaded;
extern NYA_String      nya_string_join(NYA_Arena* arena, const NYA_StringArray* arr, const char* separator) __attr_overloaded;
extern NYA_String      nya_string_join(NYA_Arena* arena, const NYA_StringArray* arr, const NYA_String* separator) __attr_overloaded;
extern NYA_String      nya_string_new(NYA_Arena* arena);
extern NYA_String      nya_string_new_with_capacity(NYA_Arena* arena, u64 capacity);
extern NYA_String      nya_string_sprintf(NYA_Arena* arena, const char* fmt, ...) __attr_fmt_printf(2, 3);
extern NYA_String      nya_string_substring_excld(NYA_Arena* arena, const NYA_String* str, u64 start, u64 end);
extern NYA_String      nya_string_substring_incld(NYA_Arena* arena, const NYA_String* str, u64 start, u64 end);
extern NYA_StringArray nya_string_split(NYA_Arena* arena, const NYA_String* str, const char* separator) __attr_overloaded;
extern NYA_StringArray nya_string_split(NYA_Arena* arena, const NYA_String* str, const NYA_String* separator) __attr_overloaded;
extern NYA_StringArray nya_string_split_lines(NYA_Arena* arena, const NYA_String* str);
extern NYA_StringArray nya_string_split_words(NYA_Arena* arena, const NYA_String* str);
extern u64             nya_string_count(const NYA_String* str, const char* substr) __attr_overloaded;
extern u64             nya_string_count(const NYA_String* str, const NYA_String* substr) __attr_overloaded;
...
extern void            nya_string_reserve(NYA_String* str, u64 capacity);
